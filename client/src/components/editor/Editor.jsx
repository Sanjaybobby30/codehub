...
function Editor() {
    ...
    const noHighlightWarned = useRef(false)
    ...
    const getExtensions = () => {
        ...
        const langExt = editorLangExtensions[language] || editorLangExtensions[langKey]
        if (langExt) {
            noHighlightWarned.current = false
            extensions.push(langExt)
        }
        // No toast here — avoids spamming every keystroke
        return extensions
    }
